...
class SimSiam_BG(nn.Module):
    ...
    def forward(self, y1, y2, b1, b2): # 2つの画像を入力
        ...
        #z1 = self.projector(self.backbone(y1)) - self.projector(self.backbone(b1))
        #z2 = self.projector(self.backbone(y2)) - self.projector(self.backbone(b2))
